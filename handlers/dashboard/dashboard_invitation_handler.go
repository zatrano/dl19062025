...
func (h *InvitationHandler) ListParticipants(c *fiber.Ctx) error {
...
func (h *InvitationHandler) UpdateParticipant(c *fiber.Ctx) error {
	id, _ := c.ParamsInt("id")
...
func (h *InvitationHandler) DeleteParticipant(c *fiber.Ctx) error {
	id, _ := c.ParamsInt("id")
