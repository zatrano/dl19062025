...
func NewSocialMediaHandler() *SocialMediaHandler {
	...
	return &SocialMediaHandler{socialMediaService: svc}
}

func (h *SocialMediaHandler) ListSocialMedias(c *fiber.Ctx) error {
...
func (h *SocialMediaHandler) ShowCreateSocialMedia(c *fiber.Ctx) error {
	return renderer.Render(c, "dashboard/social-media/create", "layouts/dashboard", fiber.Map{
		"Title": "Yeni Sosyal Medya Ekle",
	})
}

func (h *SocialMediaHandler) CreateSocialMedia(c *fiber.Ctx) error {
...
func (h *SocialMediaHandler) ShowUpdateSocialMedia(c *fiber.Ctx) error {
	id, _ := c.ParamsInt("id")
...
func (h *SocialMediaHandler) UpdateSocialMedia(c *fiber.Ctx) error {
	id, _ := c.ParamsInt("id")
	if err := requests.ValidateSocialMediaRequest(c); err != nil {
		return err
	}
...
func (h *SocialMediaHandler) DeleteSocialMedia(c *fiber.Ctx) error {
	id, _ := c.ParamsInt("id")
