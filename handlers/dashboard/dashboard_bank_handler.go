...
func NewBankHandler() *BankHandler {
	...
	return &BankHandler{bankService: svc}
}

func (h *BankHandler) ListBanks(c *fiber.Ctx) error {
...
func (h *BankHandler) ShowCreateBank(c *fiber.Ctx) error {
...
func (h *BankHandler) ShowUpdateBank(c *fiber.Ctx) error {
	id, _ := c.ParamsInt("id")
